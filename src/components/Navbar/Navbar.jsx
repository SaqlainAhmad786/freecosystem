                ...
                <nav className="customContainer navbar px-0 bg-base-100">
                    ...
                    <div className="navbar-end w-full">
                        ...
                        <div className="lg:hidden md:hidden sm:hidden">
                            <Link to="/postAd" className="px-2"><CirclePlus className="h-5 inline-block" /></Link>
                        </div>
                        <span className="lg:inline-flex md:inline-flex sm:inline-flex hidden rounded-md border bg-white shadow-md ml-1">
                            ...
                            </Link>
                            {
                                userData
                                    ? <div className="dropdown dropdown-end">
                                        <div tabIndex={0} role="button" className="flex items-center gap-1 text-sm font-medium px-3 py-2 text-gray-700 hover:bg-gray-50 focus:relative"><User className="h-4 w-4" /> {userData.firstName} <ChevronDown className="h-4 w-4" /></div>
                        ...
                        <div className="drawer w-auto lg:hidden md:hidden sm:hidden block">
                            ...
                            <div className="drawer-side z-50">
                                ...
                                <ul className="menu bg-base-200 text-base-content min-h-full w-80 p-4">
                                    ...
                                    {userData && <li className="hover:translate-x-2 duration-200"><NavLink to={'/profile'} onClick={handleSideBar} className="text-md">
                                    ...
                                    {userData && <li className="hover:translate-x-2 duration-200"><button onClick={handleLogOut} className="text-md">
