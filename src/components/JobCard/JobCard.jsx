    ...
    return (
        <>
            <div className="w-72 bg-white inline-block border border-lightOrange rounded-lg overflow-hidden">
                ...
                <Link to={`/jobDetail/${job._id}`} className="flex justify-center items-center bg-lightOrange hover:bg-orange duration-200 text-white font-medium text-sm py-2">Read more</Link>
            </div>
        </>
    )
}
