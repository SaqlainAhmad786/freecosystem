                ...
                <div className="customContainer flex flex-col justify-center mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                    <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                        <h1 className="text-5xl font-bold flex flex-col">
                            <span className="inline-block" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000" data-aos-once>Give Unused </span>
                            <span className="inline-block" data-aos="fade-right" data-aos-delay="500" data-aos-duration="1000" data-aos-once>items a</span>
                            <span className="inline-block text-lightOrange" data-aos="fade-right" data-aos-delay="800" data-aos-duration="800" data-aos-once>Second life!</span>
                        </h1>
                        <p className="mt-4 mb-8 text-lg sm:mb-12" data-aos="fade-right" data-aos-delay="1400" data-aos-duration="1000" data-aos-once>Help those in need by donating items you no longer use.</p>
